...
class DetailsParser:
    ...
    def __extractdetails(self):
        self.html_tree = self.html_tree.xpath("/div/span/div/div/div/div/div")[0]
    ...
    def __cleanhtml(self):
        html_cleaner = Cleaner(scripts=True, javascript=True, style=True, inline_style=True, remove_unknown_tags=True)
